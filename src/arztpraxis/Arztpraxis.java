...
public class Arztpraxis {
    ...
    public static void main(String[] args) {
        ...
        // Patient der Patienten ID finden
        for (int i = 0; i < tagesPatienten.length; i++) {
            if(tagesPatienten[i] != null && tagesPatienten[i].getId() == id){
                // 2x Patient Impfen:
                arzt1.patientImpfen(tagesPatienten[i]);
                arzt1.patientImpfen(tagesPatienten[i]);
